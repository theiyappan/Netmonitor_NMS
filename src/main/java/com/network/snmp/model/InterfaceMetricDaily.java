...
@NoArgsConstructor
@AllArgsConstructor
@Table("interface_metrics_daily")
public class InterfaceMetricDaily {
    @PrimaryKeyColumn(name = "system_name", type = PrimaryKeyType.PARTITIONED) private String systemName;
    @PrimaryKeyColumn(name = "day_bucket", type = PrimaryKeyType.CLUSTERED, ordinal = 0) private Instant dayBucket;
    ...
    @Column("total_scans") private Integer totalScans;
}